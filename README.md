...
## 🔥 I developed a React and Firebase based similar project. So this django based project is no longer maintained. React based project's source code link will be published soon: 
